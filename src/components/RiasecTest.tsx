...
const questions = [
  ...
  { question: "Je préfère les activités où je peux utiliser mes mains ou mon corps (bricoler, manipuler, installer, réparer).", category: "R" },
  { question: "Je suis attiré(e) par la recherche d'informations, la curiosité scientifique ou l'observation minutieuse.", category: "I" },
  ...
  { question: "Je suis prêt(e) à consacrer du temps pour aider quelqu'un à progresser ou à apprendre.", category: "S" },
  ...
  { question: "J'aime travailler dehors ou dans des lieux où l'on bouge plutôt que rester assis longtemps.", category: "R" },
  ...
  { question: "Je suis souvent la personne vers qui les autres se tournent pour demander conseil ou soutien.", category: "S" },
  { question: "J'aime prendre des initiatives et lancer de nouveaux projets ou activités.", category: "E" },
  { question: "Je suis attentif(ve) aux détails lorsqu'il s'agit de remplir des formulaires, tableaux ou documents.", category: "C" },

  { question: "Je préfère que le résultat de mon travail soit visible et tangible.", category: "R" },
  { question: "Je prends plaisir à lire, chercher ou croiser des informations pour mieux comprendre un sujet.", category: "I" },
  ...
  { question: "Je me vois bien dans un métier où l'on manipule des outils, des matériaux ou des équipements.", category: "R" },
  ...
  { question: "Je me vois bien dans un métier où l'on dirige des projets, des équipes ou des activités économiques.", category: "E" },
  { question: "Je me vois bien dans un métier où l'on gère des données, des budgets ou des procédures administratives.", category: "C" },
];
...
export default function RiasecTest({ onComplete }: RiasecTestProps) {
  ...
  const handleAnswer = (score: number) => {
    ...
    // Profil trié complet (6 lettres) + tie-break fixe
    ...
    <div className="h-screen flex flex-col bg-white">
      ...
      <div className="flex-1 flex flex-col justify-center px-6 py-4 min-h-[200px]">
        <div className="bg-gradient-to-br from-primary-50 to-white p-8 rounded-3xl border-2 border-primary-100 flex items-center justify-center min-h-[160px]">
          <p className="text-xl text-gray-800 text-center leading-relaxed">{questions[currentQuestion].question}</p>
        </div>
