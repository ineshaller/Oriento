  ...
  const renderScreen = () => {
    switch (currentScreen) {
      ...
      case 'riasec-test':
        return <RiasecTest 
          onComplete={(results) => {
            updateProfile({ riasecProfile: results });
      ...
      case 'profile':
        return <Profile 
          userProfile={userProfile}
          onEdit={() => setCurrentScreen('profile-creation')}
        />;
      default:
        return <Dashboard userProfile={userProfile} onNavigate={setCurrentScreen} onCareerClick={navigateToCareerDetail} />;
    }
  };
